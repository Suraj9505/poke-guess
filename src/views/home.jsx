      ...
      <div className="instructions d-flex flex-column justify-content-center align-items-center mt-4">
        ...
        <div className="instruction-steps">
          ...
          <ol className="list-group list-group-numbered">
            ...
            <li className="list-group-item">
              Click the <span className="text-secondary">Submit</span> button to
              submit your guess.
            </li>
          </ol>
          <ol className="list-group list-group-numbered">
            ...
            <ul className="list-group ms-5">
              ...
              <li className="ms-3 mt-3 mb-2">
                If your guess is incorrect, the game provides hints to help you
                guess correctly in your next attempt.
              </li>
            </ul>
          </ol>
          <ol className="list-group list-group-numbered">
            <ul className="list-group">
              ...
              <li className="ms-3 mt-3 mb-2 d-flex align-items-center">
                <img src={pokeball} alt="poke-ball" className="pokeball me-2" />{" "}
                :
                <h5 className="ms-2 mt-2">
